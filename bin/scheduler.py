...
time_periods = []
league_keys = []
for x in r.zrange("org.srobo.schedule", 0, -1):
    if x.find("league") != -1:
...
for x in league_keys:
    start = int(r.get("org.srobo.schedule." + x + ".start"))
    end   = int(r.get("org.srobo.schedule." + x + ".end"))
    time_periods.append((start-competition_9am, end-competition_9am))
